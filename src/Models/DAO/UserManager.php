...
class UserManager
{
    ...
    /**
     * Stockage dans cet attribut d'une instance de PDO de connexion active a la base de données
     */
    private PDO $db;
    ...
    /**
     * On se sert du constructeur pour hydrater l'attribut $db avec une instance de connexion à la BDD(recupérée via la fonction connectDb())
     */
